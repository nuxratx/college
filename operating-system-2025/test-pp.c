...
int main() {
    ...
    struct PCB new_process = {0}; // No new process in this test case (current process stays)

    // Test with no new process arriving (this simulates the current process still running)
